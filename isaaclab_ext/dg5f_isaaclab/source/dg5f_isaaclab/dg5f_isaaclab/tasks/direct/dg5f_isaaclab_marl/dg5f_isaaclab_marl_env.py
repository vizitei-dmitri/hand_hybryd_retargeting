...
from .dg5f_isaaclab_marl_env_cfg import Dg5fIsaaclabMarlEnvCfg


class Dg5fIsaaclabMarlEnv(DirectMARLEnv):
    cfg: Dg5fIsaaclabMarlEnvCfg

    def __init__(self, cfg: Dg5fIsaaclabMarlEnvCfg, render_mode: str | None = None, **kwargs):
