...
All the environments are registered in the `dg5f_isaaclab` extension.
"""
...
def main():
    """Print all environments registered in `dg5f_isaaclab` extension."""
    ...
    for task_spec in gym.registry.values():
        if str(task_spec.entry_point).startswith("dg5f_isaaclab.") and (
